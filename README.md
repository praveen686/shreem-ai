...
- 🎯 Entry points to execute your program using `python -m <shreem_ai>` or `$ shreem_ai` with basic CLI argument parsing.
...
---
# shreem_ai Flask Application

Awesome shreem_ai created by praveen686
...
```bash
git clone https://github.com/praveen686/shreem-ai shreem_ai
cd shreem_ai
make install
```
...
```bash
shreem_ai create-db   # run once
shreem_ai populate-db  # run once (optional)
shreem_ai add-user -u admin -p 1234  # ads a user
shreem_ai run
```
